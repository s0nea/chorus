...
<script setup lang="ts">
  ...
  import i18nDiffReports from '@/components/chorus/diff-report/i18nDiffReports';
  ...
  import DiffReportsEmpty from '@/components/chorus/diff-report/DiffReportsEmpty/DiffReportsEmpty.vue';
  import DiffReportsBucketCell from '@/components/chorus/diff-report/DiffReportsBucketCell/DiffReportsBucketCell.vue';
  import DiffReportsDirectionCell from '@/components/chorus/diff-report/DiffReportsDirectionCell/DiffReportsDirectionCell.vue';
  import DiffReportsProgressCell from '@/components/chorus/diff-report/DiffReportsProgressCell/DiffReportsProgressCell.vue';
  import DiffReportsStatusCell from '@/components/chorus/diff-report/DiffReportsStatusCell/DiffReportsStatusCell.vue';
  import DiffReportsConfigsCell from '@/components/chorus/diff-report/DiffReportsConfigsCell/DiffReportsConfigsCell.vue';
